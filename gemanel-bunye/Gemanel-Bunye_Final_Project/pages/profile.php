...
if(isset($_POST['update'])){
	...
	$sql = "UPDATE `users` SET `username` = '$name', `email` = '$email', `password` = '$pwd', `contact` = '$contact', `address` = '$address' WHERE `id` = '$id'";
...
<br>
	...
	<form method="post">
		...
		<div class="login-card">	
    		...
    		<h2>Complete Address: <input type="text" name="address" style="height: 80px;" value="<?php if(isset($_SESSION['address'])){ echo $_SESSION['address'];}?>"></h2>
